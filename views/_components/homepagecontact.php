<div class="cta-3">
    <div class="container text-center">
        <h3 class=" wow animated fadeInUp"  data-wow-duration="700ms" data-wow-delay="100ms">Donate to nasa blueberry foundation</h3>
        <p class=" wow animated fadeInDown"  data-wow-duration="700ms" data-wow-delay="200ms"><a href="#" class="btn btn-border-white btn-lg">Donate Now</a></p>
    </div>
</div><!--cta-3-->
        ...
        <div class="row contact-form">
            ...
            <div class="col-md-5">
                <div class=" margin-btm-30 address-info wow animated bounceIn"  data-wow-duration="700ms" data-wow-delay="200ms">
                    ...
                    <p><i class="fa fa-envelope"></i> Email: support&commat;nasabluberry.com</p>
