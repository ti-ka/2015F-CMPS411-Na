...
<div class="container"  style="background: rgba(255,255,255,.8)">
    ...
    <div class="well">
        <form action="blog/<?= $blog->slug ?>/update" method="POST"  onclick="transferContent();" enctype="multipart/form-data">
            ...
            <textarea type="text" id="content" class="form-control" name="content" rows="20"><?= $blog->content ?></textarea>
